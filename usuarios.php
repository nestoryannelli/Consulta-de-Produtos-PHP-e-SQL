...
<div class="container">
    ...
    <form action="">
        <input name="busca" placeholder="Digite o nome do cliente" type="text">
    ...
    <table>
        ...
        /** Buscar no campo de busca fabricante, modelo etc */
            ...
            $sql_code = "SELECT * 
                FROM cadastros
                WHERE nomeUsuario LIKE '$pesquisa%'";
            ...
            <?php
                ...
                while($dados = $sql_query->fetch_assoc()) {
                    ?>
                    <tr>
                        <td><?php echo $dados['idCadastro']; ?></td>
                        <td><?php echo $dados['nomeUsuario']; ?></td>
                        <td><?php echo $dados['contatoUsuario']; ?></td>
                        <td><?php echo $dados['produtoUsuario']; ?></td>
